...
public class Ejercicio10 {
            ...
            switch (opcion) {
                ...
                case 2: //MEDIA DE UN TRIMESTRE
                    if (estanNotasRellenas) {
                        mediaTrimestre(notasTrim1, notasTrim2, notasTrim3);
                    } else {
                ...
                case 3: //MEDIA DE UN ALUMNO
                    if (estanNotasRellenas) {
                        ...
                        System.out.println("La media del alumno es: " + calculaMediaAlumno(indiceAlumno, notasTrim1, notasTrim2, notasTrim3));
                    } else {
                        System.out.println("\n\b** Debes pulsar antes la opción 1, para rellenar las notas **");
                    }
                    break;
     ...
     */
    private static void mediaTrimestre(int[] notasTrim1, int[] notasTrim2, int[] notasTrim3) {
        double media = 0;
        int trimestre = pideNumero(1, 3, "Introduce trimestre (1,2 o 3)",
                "Error, numero de trimestre incorrecto, inténtelo de nuevo");
        switch (trimestre) {
            case 1:
        ...
        System.out.println("La media del trimestre " + trimestre + " es: " + media);
    }
    ...
    public static int muestraOpciones() {
        ...
        opcion = pideNumero(0, 3, "Introduce opción: ",
                "Opción no válida, inténtalo de nuevo (valores válidos de 0, 1, 2 y 3)" +
                        "");
        return opcion;
    }
    ...
    public static void rellenaArray(int[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            array[i] = pideNumero(0, 10, "\tIntroduce Nota alumno " + i + ": ", "Error, nota no valida");
        }
    }
